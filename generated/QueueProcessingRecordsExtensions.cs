...
namespace AutorestOrchestratorClient
{
    ...
    public static partial class QueueProcessingRecordsExtensions
    {
            ...
            {
                using (var _result = await operations.RetrieveQueuesProcessingStatusWithHttpMessagesAsync(expand, filter, select, orderby, top, skip, count, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
