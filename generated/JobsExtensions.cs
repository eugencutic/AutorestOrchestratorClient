...
namespace AutorestOrchestratorClient
{
    ...
    public static partial class JobsExtensions
    {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<JobDto> ResumeJobAsync(this IJobs operations, ResumeParameters resumeParameters, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
            {
                using (var _result = await operations.ResumeJobWithHttpMessagesAsync(resumeParameters, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
