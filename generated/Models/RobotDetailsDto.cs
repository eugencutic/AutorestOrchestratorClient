...
namespace AutorestOrchestratorClient.Models
{
    ...
    public partial class RobotDetailsDto
    {
        ...
        public RobotDetailsDto(string robotKey = default(string), string user = default(string), string machineName = default(string), long? machineId = default(long?), string robotName = default(string), RobotDetailsDtoRobotType? robotType = default(RobotDetailsDtoRobotType?), bool? hasLicense = default(bool?), int? tenantId = default(int?), long? organizationUnitId = default(long?), IDictionary<string, object> executionSettings = default(IDictionary<string, object>), IDictionary<string, object> authSettings = default(IDictionary<string, object>), long? id = default(long?))
        {
            RobotKey = robotKey;
            User = user;
