    ...
    internal static class SimpleUserDtoTypeEnumExtension
    {
        ...
        internal static string ToSerializedValue(this SimpleUserDtoType value)
        {
            switch( value )
            {
                ...
                case SimpleUserDtoType.Robot:
                    return "Robot";
                case SimpleUserDtoType.DirectoryUser:
                    return "DirectoryUser";
                case SimpleUserDtoType.DirectoryGroup:
        ...
        internal static SimpleUserDtoType? ParseSimpleUserDtoType(this string value)
        {
            switch( value )
            {
                ...
                case "DirectoryUser":
                    return SimpleUserDtoType.DirectoryUser;
                case "DirectoryGroup":
                    return SimpleUserDtoType.DirectoryGroup;
            }
            return null;
        }
    }
