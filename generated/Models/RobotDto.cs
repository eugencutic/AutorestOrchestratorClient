...
namespace AutorestOrchestratorClient.Models
{
    ...
    public partial class RobotDto
    {
        ...
        public RobotDto(string name, string username, RobotDtoType type, RobotDtoHostingType hostingType, string licenseKey = default(string), string machineName = default(string), long? machineId = default(long?), string externalName = default(string), string description = default(string), string version = default(string), string password = default(string), long? credentialStoreId = default(long?), RobotDtoCredentialType? credentialType = default(RobotDtoCredentialType?), IList<EnvironmentDto> environments = default(IList<EnvironmentDto>), string robotEnvironments = default(string), IDictionary<string, object> executionSettings = default(IDictionary<string, object>), long? id = default(long?))
        {
