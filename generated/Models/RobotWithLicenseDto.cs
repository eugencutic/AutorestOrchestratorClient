...
namespace AutorestOrchestratorClient.Models
{
    ...
    public partial class RobotWithLicenseDto
    {
        ...
        public RobotWithLicenseDto(string name, string username, RobotWithLicenseDtoType type, RobotWithLicenseDtoHostingType hostingType, RobotLicenseDto license = default(RobotLicenseDto), string licenseKey = default(string), string machineName = default(string), long? machineId = default(long?), string externalName = default(string), string description = default(string), string version = default(string), string password = default(string), long? credentialStoreId = default(long?), RobotWithLicenseDtoCredentialType? credentialType = default(RobotWithLicenseDtoCredentialType?), IList<EnvironmentDto> environments = default(IList<EnvironmentDto>), string robotEnvironments = default(string), IDictionary<string, object> executionSettings = default(IDictionary<string, object>), long? id = default(long?))
        {
            License = license;
        ...
        /// <summary>
        /// Gets or sets the attached license
        /// </summary>
        ...
        public RobotWithLicenseDtoType Type { get; set; }
        ...
        public RobotWithLicenseDtoHostingType HostingType { get; set; }
        ...
        public RobotWithLicenseDtoCredentialType? CredentialType { get; set; }
