...
namespace AutorestOrchestratorClient.Models
{
    ...
    public partial class AccessTokenRequest
    {
        ...
        public AccessTokenRequest(AccessTokenRequestGrantType? grantType = default(AccessTokenRequestGrantType?), string clientId = default(string), string clientSecret = default(string), string audience = default(string))
        {
            GrantType = grantType;
            ClientId = clientId;
